...
export class ElectronicsMenu extends Component {
    ...
    render() {
        let electronics = (this.state.EleMenu.length > 0 && this.state.EleMenu.filter((elect) => elect.id === 103 && elect))
        return (
            <div className={styles.responsiveGrid}>
                {electronics && electronics[0] && electronics[0].children.map((category, i) =>
                    <div key={category.id}>
